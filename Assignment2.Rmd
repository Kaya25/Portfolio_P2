...
p_RF = ggplot(Data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of correct answer")+ ylab("posterior probability")+ ggtitle("RF") + ylim(0,1)
p_RF
...
p_KT = ggplot(Data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of correct answer")+ ylab("posterior probability")+ ggtitle("KT") + ylim(0,1)
p_KT
...
p_JS = ggplot(Data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of correct answer")+ ylab("posterior probability")+ ggtitle("JS") + ylim(0,1)
p_JS
...
p_MW = ggplot(Data,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("probability of correct answer")+ ylab("posterior probability")+ ggtitle("MW") + ylim(0,1)
p_MW
...
# Compute the likelihood at each value in grid
likelihood <- dbinom(1600, size=1980, prob=p_grid )
...
# Compute the likelihood at each value in grid
likelihood <- dbinom(660, size=1320, prob=p_grid )
...
# Define the prior
prior = dnorm(p_grid, mean=0.5, sd=0.5)
...
# How much is above the chance level - intervals of defined boundaries
